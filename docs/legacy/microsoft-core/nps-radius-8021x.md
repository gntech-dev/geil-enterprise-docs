...
- [Enterprise Port Reference](../platform/enterprise-port-reference.md), [Firewall Rule Matrix](../../network/firewall-rule-matrix.md), [Enterprise Group Strategy](../../microsoft-core/group-strategy.md), and [Enterprise Service Account Standard](../../microsoft-core/service-account-standard.md) reviewed.
