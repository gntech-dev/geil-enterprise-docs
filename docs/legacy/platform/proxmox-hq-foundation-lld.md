...
| `HQ-MGMT01` | net0 | `vmbr1` | 10 | Management VLAN |
...
| `HQ-MGMT01` | Windows 11 Enterprise management workstation / initial PAW | 2 | 8 GB | 100 GB | VLAN 10 | Clone from Windows 11 golden template; static/reserved `172.20.10.10`; Management Workstations OU; RSAT/admin tools after domain join |
...
| `CP-MGMT01-OS` | `HQ-MGMT01` | After clone, VLAN10 management validation, domain join, Management Workstations OU placement, RSAT, and updates | Return to clean management workstation |
