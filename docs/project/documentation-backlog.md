...
| DOC-002 | P0 | Open | Add privileged access model | Tier 0/1/2 OU, group, workstation, sign-in, and emergency access controls documented | Target: `docs/security/privileged-access-model.md` |
