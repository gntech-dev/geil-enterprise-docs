...
| E06 Security Assurance and Compliance | WIN.R02 | Host Firewall and Local Admin Protection | In Progress | [Windows Firewall Baseline](../microsoft-core/windows-security/windows-firewall-baseline.md); future Windows LAPS document |
