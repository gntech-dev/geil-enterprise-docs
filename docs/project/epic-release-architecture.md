...
| 5 | Microsoft Defender Baseline | In progress | Establishes practical endpoint protection after firewall behavior and local admin control are defined. |
...
| WIN.R03 | E06 | Endpoint Protection and Monitoring | In progress: Microsoft Defender Baseline; planned: Windows Event Forwarding |
