...
| WIN.R02 | E06 | Host Firewall and Local Admin Protection | In progress: Windows Firewall Baseline; planned: Windows LAPS |
| WIN.R03 | E06 | Endpoint Protection and Monitoring | Planned: Microsoft Defender Baseline, Windows Event Forwarding |
