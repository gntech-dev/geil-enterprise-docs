...
GEIL Phase 1 is governed by the [Enterprise Lab Blueprint HLD](../legacy/architecture/enterprise-lab-blueprint.md) and its supporting Network, Identity, and Operations HLDs. Future implementation documents must reference the HLD before defining product-specific configuration.
...
- [Proxmox HQ Foundation LLD](../legacy/platform/proxmox-hq-foundation-lld.md)
- [MikroTik CHR HQ Foundation LLD](../legacy/platform/mikrotik-chr-hq-foundation-lld.md)
- [Phase 1 Build Plan](../legacy/platform/phase-1-build-plan.md)
...
- [Proxmox HQ Foundation Implementation Runbook](../legacy/platform/proxmox-hq-foundation-implementation.md)
