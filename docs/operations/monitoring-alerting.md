...
- Audit focus: Define monitoring after the management and service endpoints exist.
...
- What the `Monitoring and alerting operations` workstream changes.
...
- ✓ Completed the `Monitoring and alerting operations` workstream.
...
- `Monitoring and alerting operations` is complete and validated.
...
flowchart LR
    ...
    STEP[Monitoring and alerting operations]
